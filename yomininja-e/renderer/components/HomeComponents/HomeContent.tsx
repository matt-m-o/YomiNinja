            ...
            <Card variant="elevation" sx={{ borderRadius: 4, mb: 3, pl: 1, pr: 1 }}>
                <CardContent>
                    ...
                    >
                        ...
                        <li>
                            <strong> New screen capture method for up to 10x faster screenshots. </strong>
                        </li>

                        <li>
                            <strong> Improved screenshot quality, potentially boosting OCR accuracy. </strong>
                        </li>

                        <li>
                            <strong> Browser extensions can now access screenshots, fixing the Yomitan mining issue. </strong>
                        </li>

                        <li>
                            <strong> Initial support for the Wayland window system (tested on Nobara KDE and Ubuntu). </strong>
                        </li>

                        <li>
                            <strong> Added a button next to each hotkey setting to copy the equivalent CLI command. </strong>
                        </li>

                        <li>
                            <strong> Added a button to refresh the capture sources list. </strong>
                        </li>

                        <li>
                            <strong> Experimental API for controlling the app from third-party applications. </strong>
                        </li>

                        <li>
                            <strong> Enhanced multi-monitor support for macOS and Linux. </strong>
                        </li>

                        <li>
                            <strong>The hotkey for moving and resizing the overlay is now customizable.</strong>
                        </li>

                        <li>
                            <strong> Updated the built-in Yomitan extension to version 24.10.7.1. </strong>
                        </li>
